...
public class Player_eachColor : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            switch (Porder_DontDestroy.DontDestroy_Porder)
            {
                case 1: j = 1; break;
                case 2: j = 2; break;
                case 3: j = 3; break;
            ...
            {
                case 1:
                    Debug.Log("PorderÇÕ:" + Porder_DontDestroy.DontDestroy_Porder);
                ...
                case 4:
                    ...
                    break;
                default: Debug.Log("Porderà¯Ç´ìnÇµÉGÉâÅ[:" + Porder_DontDestroy.DontDestroy_Porder); break;
            }
            //mesh.enabled = false;
